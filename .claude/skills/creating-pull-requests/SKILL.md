...
| File | Why |
|---|---|
| `project_core/utils/caching.py` *(start here)* | New `RoutingCacheContext` — all routing logic lives here. |
| `project_core/constants.py` | `FeatureSizeHint` enum and Bigtable constants. |
| `ml-toolkit/converters/base.py` | Converters declare `feature_size_hint`. |
