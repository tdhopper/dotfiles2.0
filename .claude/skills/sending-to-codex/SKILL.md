...
**Example:**
```bash
codex exec --ephemeral -o /tmp/codex-response.md -C /Users/thopper/c/my-project "Explain how the converter DAG in project_core/converters works and identify any potential circular dependencies"
```
